...
function getTemplates(){
	$.ajax({
		...
		success: function(result) {
			...
			$("#mapperTemplate").html(result.templates.dao);
			$("#mapperxmlTemplate").html(result.templates.mapping);
...
function getCode() {
	...
	$.ajax({
		...
		success: function(result) {
			...
			$("#mapper").html(result.bzClass.dao);
			$("#mapperxml").html(result.bzClass.mapping);
